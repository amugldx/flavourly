      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            A platform dedicated to providing accurate nutritional information
            and high-quality recipes through the collaboration of passionate
            recipe developers and certified nutritionists.
          </p>
        </div>
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              At Flavourly, we believe that everyone deserves access to accurate
              nutritional information when making food choices. Our platform
              bridges the gap between creative recipe development and
              professional nutritional expertise.
            </p>
            <p className="text-muted-foreground">
              By combining the creativity of passionate recipe developers with
              the expertise of certified nutritionists, we ensure that every
              recipe on our platform is not just delicious, but also
              nutritionally accurate and beneficial for your health.
            </p>
          </CardContent>
        </Card>
