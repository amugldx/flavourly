...
import { ArrowLeft, BookOpen, Calendar, CheckCircle, Clock, Eye, User } from 'lucide-react';
		...
		return (
			<div className='container mx-auto px-4 py-6 max-w-7xl'>
				<div className='flex flex-col items-center justify-center min-h-[400px] space-y-4'>
					...
					<h2 className='text-xl font-semibold'>Nutritionist not found</h2>
							...
							<div className='space-y-3'>
								<div className='flex items-center justify-between p-3 bg-muted rounded-lg'>
									<div className='flex items-center gap-2'>
										...
										<span className='text-sm'>Recipes Reviewed</span>
									</div>
						...
						<CardContent>
							{nutritionist.verifiedRecipes.length > 0 ? (
								...
								<div className='text-center py-12'>
									...
									<h3 className='text-lg font-semibold mb-2'>No recipes reviewed yet</h3>
