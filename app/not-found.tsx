  ...
  const helpfulTips = [
    {
      ...
      description:
        "Use the main navigation menu to find what you're looking for.",
    },
    {
      icon: Search,
      title: "Search Recipes",
      description:
        "Use our search feature to find specific recipes or ingredients.",
    },
    {
      icon: BookOpen,
      title: "Browse Categories",
      description:
        "Explore recipes by meal type, cuisine, or dietary preferences.",
    },
  ];
            ...
            <div className="text-center space-y-4">
              <div className="p-4 bg-muted/30 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  If you believe this page should exist or you're experiencing
                  technical difficulties, please don't hesitate to contact our
                  support team.
                </p>
