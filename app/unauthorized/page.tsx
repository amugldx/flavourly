      ...
      case "Admin":
        return {
          ...
          availableRoutes: [
            ...
            { path: "/dashboard", label: "Recipe Dashboard" },
            { path: "/nutritionist", label: "Nutritionist Dashboard" },
          ],
        };
      default:
        ...
        <Card className="border-destructive/50 shadow-lg">
          ...
          <CardContent className="text-center space-y-4">
            <Alert className="border-destructive/50">
              ...
              <AlertDescription>
                This page is restricted to specific user roles. Please check
                your permissions or contact an administrator if you believe this
                is an error.
              </AlertDescription>
            </Alert>
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="p-3 bg-muted rounded-lg">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Some features require specific roles. Check if you need to
