...
import { NutritionDataSource } from "@/generated/prisma/client";
...
export default function NutritionalInfoForm({
  recipe,
  onUpdate,
  ...
  const handleSave = () => {
    ...
    const processedData = Object.entries(nutritionalData).reduce(
      (acc, [key, value]) => {
        if (key === "dataSource") {
          acc[key] = value;
        } else {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Badge variant={isDataSourceVerified ? "default" : "secondary"}>
                {nutritionalData.dataSource ===
                NutritionDataSource.verified_nutritionist
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("proteinGrams", e.target.value)
                  }
                  placeholder="0"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("carbohydratesGrams", e.target.value)
                  }
                  placeholder="0"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("fatGrams", e.target.value)
                  }
                  placeholder="0"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("fiberGrams", e.target.value)
                  }
                  placeholder="0"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("sugarGrams", e.target.value)
                  }
                  placeholder="0"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("sodiumMg", e.target.value)
                  }
                  placeholder="0"
                />
              </div>
