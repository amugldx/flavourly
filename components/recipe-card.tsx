			...
			<div className='flex flex-col flex-1 p-4'>
				...
				{recipe.averageRating && (
					<div className='flex items-center gap-2 mb-3'>
						<div className='flex items-center gap-1'>{renderStars(recipe.averageRating)}</div>
						<span className='text-sm text-muted-foreground'>({recipe.reviewCount} reviews)</span>
					</div>
				)}
